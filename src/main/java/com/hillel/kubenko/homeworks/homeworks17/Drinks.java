package com.hillel.kubenko.homeworks.homeworks17;

public class Drinks {
    public static final double COFFEE_PRICE = 10.0;
    public static final double TEA_PRICE = 8.0;
    public static final double LEMONADE_PRICE = 6.0;
    public static final double MOCHITO_PRICE = 10.0;
    public static final double MINERAL_WATER_PRICE = 5.0;
    public static final double COCA_COLA_PRICE = 7.0;
