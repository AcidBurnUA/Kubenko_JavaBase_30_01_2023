...
//            System.out.println("Введіть імя");
//            String fon = s.nextLine();
//        personInfo(name,city,surname,fon);
//            Scanner s = new Scanner(System.in);
//            System.out.println("Введіть імя");
//            String name = s.nextLine();
//            System.out.println("Введіть імя");
...
//        personInfo(name,city,surname,fon);
//    }
//    static void personInfo(String name,String city,String Surname,String fon){
//        System.out.println("Зателефонувати громадянину "+name+" "+Surname+" із міста "+city+" можна за номером "+fon);
//
//    }
